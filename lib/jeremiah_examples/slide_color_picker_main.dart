...
/// DartPad: https://dartpad.dev/?id=01d2587083a76a22e40d1e30976336b9
///
/// Features: Horizontal color spectrum slider, preview popup, arrow indicator handle
/// Techniques: Custom RenderBox, HorizontalDragGestureRecognizer, TapGestureRecognizer, HSL colors, AnimationController
...
class RenderColorPicker extends RenderBox {
  RenderColorPicker({
    ...
    slideController =
        AnimationController.unbounded(value: 0.0, vsync: _vsync, duration: const Duration(milliseconds: 350));
  }
  ...
  void attach(PipelineOwner owner) {
    ...
    slideController.addListener(markNeedsPaint);
  }
