...
/// DartPad: https://dartpad.dev/?id=eb2777d101bbed1081f2afaca4f1c729
///
/// Features: Dual concentric dial for hours/minutes, AM/PM toggle with animation, spring physics
/// Techniques: Custom RenderBox, ContainerRenderObjectMixin, TapGestureRecognizer, SpringSimulation
...
class TimeOfDayRenderBox extends RenderBox {
  ...
  late ValueChanged<TimeOfDayType> _onChanged;

  set onChanged(ValueChanged<TimeOfDayType> onChanged) {
    _onChanged = onChanged;
  }

  late TimeOfDayType _value;
...
class DialWidget extends LeafRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    covariant DialRenderBox renderObject,
  ) {
    renderObject
      ..onChanged = onChanged
      ..time = time;
...
class DialRenderBox extends RenderBox
  ...
  late TimeValueChanged _onChanged;
  ...
  void performLayout() {
    ...
    while (child != null) {
      ...
      final DialParentData? childParentData =
          child.parentData as DialParentData?;
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    context.canvas.drawCircle(
      child.center + (child.parentData as DialParentData).offset,
      child.radius,
