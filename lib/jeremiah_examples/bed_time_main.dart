...
/// DartPad: https://dartpad.dev/?id=59efa9b1ac3fab64fb6ce251c8575862
///
/// Features: iOS-style bed time dial, draggable sleep/wake handles, arc-based time selection
/// Techniques: Custom RenderBox, PanGestureRecognizer, arc drawing, angle-to-time conversion, haptic feedback
...
class BedTimeWidget extends LeafRenderObjectWidget {
  ...
  RenderSlideButton createRenderObject(BuildContext context) {
    return RenderSlideButton(bedTime: bedTime, wakeTime: wakeTime, threshold: threshold).._onChange = onChange;
  }
